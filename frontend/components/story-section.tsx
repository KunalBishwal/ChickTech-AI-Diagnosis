...
export default function StorySection() {
  ...
  return (
    <section
      id="story"
      ref={sectionRef}
      className="py-24 bg-gradient-to-b from-red-50 via-white to-green-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 relative overflow-hidden"
    >
      {/* Background */}
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-red-50/80 via-white/90 to-green-50/80 dark:from-gray-900/80 dark:via-gray-950/90 dark:to-gray-900/80" />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div ref={statsRef} className="grid md:grid-cols-3 gap-8 mb-16 place-items-center">
          {[
            ...
            <ScrollReveal
              ...
              delay={0.2 * (i + 1)}
            >
              <div className="relative w-full sm:w-80 md:w-96 text-center p-10 bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-2xl shadow-xl border border-red-100/50 dark:border-red-900/30 hover:-translate-y-2 hover:shadow-2xl transition-all duration-500">
        ...
        <div className="w-full max-w-2xl mx-auto">
          {!loading && (
            <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-4 opacity-80 animate-fadeIn">
              Data last updated:{" "}
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <ScrollFloat speed={0.2} className="relative">
              <ScrollReveal direction="right" delay={0.3}>
                <div className="bg-gradient-to-br from-green-50/80 to-blue-50/80 dark:from-gray-800/80 dark:to-gray-700/80 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-green-100/50 dark:border-gray-600/50">
                  <div
                    ref={heroMascotRef}
                  ...
                  <div className="mt-8 text-center">
                    <h4 className="text-2xl font-bold mb-3 text-gray-900 dark:text-white">ChickTech AI</h4>
